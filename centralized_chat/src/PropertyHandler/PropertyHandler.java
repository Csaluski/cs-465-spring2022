...
/**
 * class [PropertyHandler.PropertyHandler]
 * <p>
...
public class PropertyHandler extends Properties {
    ...
    private File getPropertyFile(String propertyFileString)
        ...
        throw new FileNotFoundException("[PropertyHandler.PropertyHandler.PropertyHandler.PropertyHandler] Configuration file \"" + propertyFileString + "\" not found!");
    }
}
